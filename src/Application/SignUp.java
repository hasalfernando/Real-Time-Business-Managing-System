...
public class SignUp {
    ...
    private void sendPin(){ //Send the pin to the user's email
        ...
        String from = "jfsmarketting@gmail.com"; //from
        final String username = "jfsmarketting@gmail.com";//the email username
        final String password = "jeffsmith123";//email password
