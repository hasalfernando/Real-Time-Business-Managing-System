...
public class Main extends Application {
    ...
    public static void main(String[] args) throws SQLException { //launch the application
        ...
        if (nextSendMonth == month) {
            ...
            String from = "jfsmarketting@gmail.com"; //The from email address shown in the email
            final String username = "jfsmarketting@gmail.com";//The email username needed to log in
            final String password = "jeffsmith123";//The password needed to log in
